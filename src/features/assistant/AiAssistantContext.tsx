...
const WELCOME: AssistantMessage = {
  ...
  role: 'assistant',
  content:
    'Здравствуйте! Меня зовут Клариса — я ваш ассистент в INCLAVE. Помогу с задачами, календарём, проектами, финансами и кадрами. Например: «Сколько у нас сотрудников?», «Покажи финансовую сводку» или «Создайте задачу до пятницы».',
