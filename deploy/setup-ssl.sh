...
echo "  iPhone: http://${SERVER_IP}/trust-cert.html"
echo ""
echo "  На iPhone Safari установите сертификат через trust-cert.html,"
echo "  иначе сайт по HTTPS может не загружаться после предупреждения."
echo "============================================"
